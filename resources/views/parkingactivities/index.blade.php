            ...
            <div class="col-md-12">
                <div class="card border-0 shadow rounded">
                    <div class="card-body">
                        ...
                        <form action="{{ route('parkingactivities.index1') }}" method="GET" class="mb-3">
                            @csrf
                            <div class="row">
                                <div class="col-lg-4 d-flex">
                                    <button type="submit" class="btn btn-info mx-3">History Parkir</button>
                                </div>
                            </div>
                        </form>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                @php $no = 1; @endphp
                                @forelse ($listactivities as $data)
                                    <tr>
                                ...
                                @empty
                                    <div class="alert alert-danger">
                                        Data Aktivitas Parkir Hari ini belum Tersedia.
                                    </div>
                                @endforelse
                            </tbody>
                        </table>
